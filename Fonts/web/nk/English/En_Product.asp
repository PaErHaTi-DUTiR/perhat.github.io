...
strFileName="En_Product.asp?EnBigClassName=" & EnBigClassName & "&EnSmallClassName=" & EnSmallClassName 
%>
...
<%
if totalput>0 then
call showpage(strFileName,totalput,MaxPerPage - 1,false,true," a product")
end if
%> 
						</td>
					</tr>
