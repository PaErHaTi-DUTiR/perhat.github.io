...
<!--
td {  font-family: "Arial,TFixedsys"; font-size: 9pt; color: #333333; text-decoration: none}
-->
</style>
</head>
<body>
...
<table width='300'border='1' align='center'cellpadding='4'cellspacing='0' bordercolor="#666666" class='border'>
	<tr >
    <td height='15'colspan='2' align="center" background="../Chinese/images/b1.gif" class='title'>Operation: Confirm that the identity fails!</td>
	</tr>
	<tr>
    <td height='23'colspan='2' align="center" bgcolor="#CCCCCC" class='tdbg'> <br>
      <br> User name or password mistake! Or this account number is locked ！！<br>
      <br> <a href='javascript:onclick=history.go(-1)'>【Return】</a> <br>
      <br></td>
	</tr>
</table>
