		...
		<TR> 
			<TD>
				<TABLE cellSpacing=0 cellPadding=0 align='center' class='MC_ServeNr_Title'>
					<TR vAlign=top > 
						<TD  width="80%" height="18"> <form method="post" action="En_NetBooKSave.asp">
							<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr> 
									<td width="100%"> <div align="center"> 
										<table width="100%" height="79" border="0" align="center" cellpadding="0" cellspacing="3">
											<tr> 
												<td width="23%" height="25" align="right">UserName：</td>
												<td width="77%" height="25"><font> 
												<input type="text" readonly name="Name" maxlength="36" value="<%if Session("UserName")="" then response.write"Not register user" end if%><%=Session("UserName")%>" style="background-color: #FFFFFF; border-style: solid; border-color: #FFFFFF" class="smallInput">
												</font></td>
											</tr>
											<tr> 
												<td width="23%" height="25" align="right">CompanyName：</td>
											...
											<tr> 
												<td height="25" align="right">ContactPerson：</td>
											...
											<tr> 
												<td width="23%" height="25" align="right">FeedbackTheme：</td>
												<td width="77%" height="25"><input type="text" name="Title" size="42" maxlength="36" style="font-size: 14px" class="smallInput"></td>
											</tr>
											<tr> 
												<td width="23%" height="1" valign="top" align="right">FeedbackContent：</td>
												<td width="77%" height="1" valign="top"><textarea rows="10" name="Content" cols="45" style="font-size: 14px" class="smallInput"></textarea></td>
											</tr>
											<tr> 
												<td width="23%" height="0" valign="top"> </td>
												<td width="77%" height="0" valign="top"> 
												<input type="submit" value="ReferWord" 
												name="cmdOk"> <input type="reset" value="Rewrite" name="cmdReset"> </td>
											</tr>
										</table>
									</div></td>
								</tr>
