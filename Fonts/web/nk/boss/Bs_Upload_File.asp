...
<table cellpadding="2" cellspacing="1" border="0" width="560" align="center" class="a2">
	<tr>
		<td class="a1" height="25" align="center"><strong>上 传 文 件 管 理</strong></td>
	</tr>
	<tr class="a4">
		<td align="center">
<%
...
%>
        <tr bgcolor="#E3E3E3" class="tdbg"> 
          ...
          <td width="43" align="center"><a href="Bs_Upload_File.asp?Action=Del&FileName=<%=UploadDir&theFile.Name%>" onclick="return ConfirmDel()">删除</a></td>
        </tr>
<%
		FileCount=FileCount+1
		TotleSize=TotleSize+theFile.Size
