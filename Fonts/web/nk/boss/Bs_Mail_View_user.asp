...
<table cellpadding="2" cellspacing="1" border="0" width="560" align="center" class="a2">
	<tr>
		<td class="a1" height="25" align="center"><strong>用户管理</strong></td>
	</tr>
	<tr class="a4">
		<td align="center">
      <br>
      <table border="0" cellpadding="0" cellspacing="0" width="550" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" class=ver>
        <tr> 
          ...
          <td height="25" colspan="4"  class="ver"> <font class=ver>&nbsp;共有[<font color="#ff0000"><%=rs.recordcount%></font>]Email地址 
            以下是[<font color="red">1～<%=rs.recordcount%></font>]个&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Bs_Mail_Add_user.asp">添加邮件地址</a></font></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="25" colspan="4" ><font class=ver> 
            ...
            共有[<font color="#ff0000"><%=rs.recordcount%></font>]Email地址 以下是[<font color="red"><%=page_start%>～<%=page_end%></font>]</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Bs_Mail_Add_user.asp">添加邮件地址</a></td>
        </tr>
        <tr> 
          <td height="25" colspan="4" > 
            <% response.write"<form name=go2to form method=Post action='Bs_Mail_view_user.asp?key="+key+"'>"
             ...
             response.write "<a href=Bs_Mail_view_user.asp?page=1&key="+key+"><font class=ver>首页</font></a>&nbsp;" 
	         response.write "<a href=Bs_Mail_view_user.asp?page="+cstr(pagecount-1)+"&key="+key+"><font color='0000BE'>上一页</font></a>&nbsp;"
			 end if                                             
             if rs.PageCount-pagecount<1 then                                                        
             response.write "<font class=ver>下一页 尾页</font>"                                                    
			 else                                                        
             response.write "<a href=Bs_Mail_view_user.asp?page="+cstr(pagecount+1)+"&key="+key+"><font class=ver>下一页</font></a>&nbsp;"
			 response.write "<a href=Bs_Mail_view_user.asp?page="+cstr(rs.PageCount)+"&key="+key+"><font class=ver>尾页</font></a>"           
             end if 
      ...
      <table border="0" cellspacing="2" cellpadding="0" width="550">
        ...
        <tr bgcolor="#E3E3E3"> 
          ...
          <td width="16%" > <p align="center"><font color="#000000">[<a href="Bs_Mail_view_user.asp?del=<%=rs("id")%>"><font class=ver>删除</font></a>]</font> 
            </p></td>
        </tr>
        <% i=i+1                                                                                                  
          rs.movenext                                                                                                  
