...
<table cellpadding="2" cellspacing="1" border="0" width="560" align="center" class="a2">
	<tr>
		<td class="a1" height="25" align="center"><strong>修改形象</strong></td>
	</tr>
	<tr class="a4">
		<td align="center">
      <br>
          ...
          <form method="post" name="myform" action="Bs_Img_edit.asp?no=eshop">
            ...
            <td><div align="center"> 
							<table width="100%" border="0" cellspacing="2" cellpadding="3">
								<tr> 
									<td width="18%" height="25" bgcolor="#C0C0C0"> <div align="right">形象名称</div></td>
								...
								<tr> 
									<td height="22" bgcolor="#E3E3E3"><div align="right">形象证书</div></td>
