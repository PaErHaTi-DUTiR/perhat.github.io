...
<table cellpadding="2" cellspacing="1" border="0" width="610" align="center" class="a2">
	<tr>
		<td class="a1" height="25" align="center"><strong>产 品 审 核</strong></td>
	</tr>
	<tr class="a4">
		<td align="center"><BR>
...
%>
			...
			<table width="600" height="22" border="0" cellpadding="0" cellspacing="2">
				<tr> 
					<td width="453" height="22" bgcolor="#CCCCCC"><a href="Bs_Product_Check.asp">&nbsp;产品审核</a>&nbsp;&gt;&gt;&nbsp; 
<%
...
%>
<a href="Bs_Product_Check_Set.asp?Action=Check&ArticleID=<%=rs("ArticleID")%>">通过审核</a> 
<% Else %>
<a href="Bs_Product_Check_Set.asp?Action=CancelCheck&ArticleID=<%=rs("ArticleID")%>">取消通过</a> 
<%
	End If
end if
%>
...
%>
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0">
				<tr> 
					...
					<input name="chkAll" type="checkbox" id="chkAll" onclick=CheckAll(this.form) value="checkbox">选中本页显示的所有产品</td>
					<td><input name="submit" type='submit'
					value="<%if Passed="True" then response.write "取消"%>审核选定的产品" 
