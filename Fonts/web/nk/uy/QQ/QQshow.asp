...
<script>
if (online[<%=n%>]==0)
document.write("<tr><td align=right><a class='c'target=blank href='http://wpa.qq.com/msgrd?V=1&Uin=<%=QQ(n)%>&Site=多风格2006商业版&Menu=no'><img alt='<p align=left><%=qqmsg_off%>'src=../images/qq/QQoff<%=qqskin%>.gif border=0 align=middle></a></td><td><a class='c'target=blank href='http://wpa.qq.com/msgrd?V=1&Uin=<%=QQ(n)%>&Site=多风格2006商业版&Menu=no'alt='<p align=left><%=qqmsg_off%>'><%=QQ_name(n)%></a></td></tr>");
else
document.write("<tr><td align=right><a class='b'target=blank href='http://wpa.qq.com/msgrd?V=1&Uin=<%=QQ(n)%>&Site=多风格2006商业版&Menu=no'><img alt='<p align=left><%=qqmsg_on%>'src=../images/qq/QQon<%=qqskin%>.gif border=0 align=middle></a></td><td><a class='b'target=blank href='http://wpa.qq.com/msgrd?V=1&Uin=<%=QQ(n)%>&Site=多风格2006商业版&Menu=no'alt='<p align=left><%=qqmsg_on%>'><%=QQ_name(n)%></a></td></tr>");
</script >
<%next%>
</table></td></tr>
