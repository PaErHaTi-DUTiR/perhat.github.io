...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'يازما','prev'=>'ئالدىنقى بەت','next'=>'كىيىنكى بەت','first'=>'باش بەت','last'=>'ئاخىرقى بەت',
        'theme'=>'&nbsp;&nbsp;جەمئى %totalRow% %header% &nbsp;&nbsp; بەت %totalPage%/%nowPage% &nbsp; %nextPage% %upPage% %downPage% %first%  %prePage%  %linkPage% %end%');
    // 默认分页变量名
    protected $varPage;
